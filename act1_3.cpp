...
int mainC(const vector<Bitacora>& registros) {
    ...
    cout << "1. Obtener la direccion IP actual y sus conexiones.\n2. Encontrar numero de conexiones entrantes\n3. Encontrar numero de conexiones salientes\n4. Comprobar si la red tiene 3 conexiones seguidads" << endl;
